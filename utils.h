...
void packet_cpy(const struct packet *original, struct packet *copy) {
  copy->seqnum = original->seqnum;
  copy->acknum = original->acknum;
  copy->ack = original->ack;
